      ...
      typography: () => ({
        DEFAULT: {
          css: {
            ...
            '--tw-prose-lead': 'oklch(var(--color-neutral-700))',
            ...
            '--tw-prose-hr': 'oklch(var(--color-neutral-300))',
            '--tw-prose-quotes': 'oklch(var(--color-neutral-900))',
            '--tw-prose-quote-borders': 'oklch(var(--color-neutral-300))',
            '--tw-prose-captions': 'oklch(var(--color-neutral-600))',
            ...
            '--tw-prose-invert-body': 'oklch(var(--color-neutral-200))',
            '--tw-prose-invert-headings': 'oklch(var(--color-neutral-50))',
            '--tw-prose-invert-lead': 'oklch(var(--color-neutral-200))',
            '--tw-prose-invert-links': 'oklch(var(--color-neutral-50))',
            '--tw-prose-invert-bold': 'oklch(var(--color-neutral-50))',
            ...
            '--tw-prose-invert-code': 'oklch(var(--color-neutral-50))',
            '--tw-prose-invert-pre-code': 'oklch(var(--color-neutral-200))',
