...
export const DrawerContent = ({
  ...
  <DrawerPortal data-slot='drawer-portal'>
    ...
    <DrawerPrimitive.Content
      ...
      className={cn(
        'group/drawer-content fixed z-50 flex h-auto w-dvw max-w-screen-sm flex-col bg-popover pb-[env(safe-area-inset-bottom)] shadow shadow-neutral-900/50 focus-visible:outline-none',
